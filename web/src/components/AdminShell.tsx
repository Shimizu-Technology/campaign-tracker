...
const adminSidebarStorageKey = 'campaign-admin-sidebar-collapsed';
  ...
  const sidebarContent = (collapsed = false) => (
    <nav className="flex flex-col h-full">
      ...
      <div className={collapsed ? 'px-3 pt-3 pb-2' : 'px-3 pt-4 pb-3'}>
        <Link to="/admin" className="block" onClick={() => { hideRailTooltip(); setSidebarOpen(false); }} title={collapsed ? 'Campaign Operations' : undefined}>
          <WorkspaceBrandPanel
            compact
            rail={collapsed}
